...
trait ExpressionParser {
  ...
  /**
    ...
    */
  def detectDataSource(plan: LogicalPlan): Option[(String, Seq[String])]
...
class DefaultExpressionParser extends ExpressionParser {
  ...
  /**
    ...
    * @return Option(TABLE_NAME)
    */
  override def findTableAliasForColumn(columnId: String, plan: LogicalPlan): Option[String] = {
  ...
  /**
    ...
    * @return expression as pretty string
    */
  override def toPrettyExpression(expr: Expression,
                                  rootPlan: Option[LogicalPlan] = None,
                                  isDataSource: Boolean = false,
                                  withoutTableName: Boolean): String = {
  ...
  /**
    ...
    * @return Option(SOURCE_FORMAT, Option(Seq(path)))
    */
  override def detectDataSource(plan: LogicalPlan): Option[(String, Seq[String])] = plan match {
